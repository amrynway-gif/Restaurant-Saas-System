    ...
    <div className="space-y-6">
      ...
      <Card className="border-border/50 bg-card/80 backdrop-blur">
        <CardHeader>
          ...
          <CardDescription>
            Steuere die Helden- und Fußzeilentexte, die deinen Kunden auf der Menüseite angezeigt werden.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {restaurant && (
...
Von der Tabellenseite. Der Name des Kellners erscheint in Bestellungen und Filter sind nach Tisch und Kellner verfügbar.
      ...
      <Card className="border-border/50 bg-card/80 backdrop-blur">
        <CardHeader>
          ...
          <CardDescription>
            Bestimmen Sie, wie viel der Kunde zahlt, um einen Punkt zu sammeln, und welchen Wert der Punkt bei der Ermäßigung hat. Gilt für Bestellungen
Neu beim Aktivieren des Programms.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {restaurant && (
